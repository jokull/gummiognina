...
(function() {
  ...
  window.Router = (function() {
    ...
    Router.prototype.page = function(id) {
      window.GummiNina.collections.photos.page = num;
      return window.GummiNina.collections.photos.expand();
    };
    return Router;
  })();
  ...
  window.Photos = (function() {
    __extends(Photos, Backbone.Collection);
    function Photos() {
  ...
  window.PhotosView = (function() {
    __extends(PhotosView, Backbone.View);
    function PhotosView() {
      this.addOne = __bind(this.addOne, this);
      this.addAll = __bind(this.addAll, this);
      this.updateLoadLink = __bind(this.updateLoadLink, this);
      PhotosView.__super__.constructor.apply(this, arguments);
    }
    PhotosView.prototype.el = "#photos";
    PhotosView.prototype.initialize = function(options) {
      this.collection.bind("add", this.addOne);
      this.collection.bind("reset", this.addAll);
      return this.collection.bind("updated", this.updateLoadLink);
    };
    PhotosView.prototype.updateLoadLink = function() {
      return (this.$(".load-next")).attr("href", "#" + this.collection.url());
    };
    PhotosView.prototype.addAll = function() {
      $(".photos-list", this.el).html("");
    ...
    PhotosView.prototype.addOne = function(model) {
      ...
      $el = $(view.render().el);
      return this.$(".photos-list").append($el);
    };
    return PhotosView;
  })();
  $(function() {
